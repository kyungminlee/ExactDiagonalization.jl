...
#   for (b, v) in zip(psi.hilbert_space_representation.basis_list, psi.components)
...
#   if out.hilbert_space_representation !== psi.hilbert_space_representation || pureop.hilbert_space !== psi.hilbert_space_representation.hilbert_space
...
#   if out.hilbert_space_representation !== psi.hilbert_space_representation || sumop.hilbert_space !== psi.hilbert_space_representation.hilbert_space
...
#   end
#   S3 = promote_type(S1, S2)
#   out = DenseState{S3, QN, BR}(psi.hilbert_space_representation)
#   apply_unsafe!(out, pureop, psi)
#   return out
# end
#
